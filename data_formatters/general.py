...
class GeneralFormatter(GenericDataFormatter):
    ...
    def set_scalers(self, df):
        ...
        for identifier, sliced in df.groupby(id_column):
            ...
            if len(sliced) >= self._time_steps:
                ...
                self._target_scaler[identifier] = sklearn.preprocessing.LabelEncoder().fit(targets.reshape(len(targets), ))
    ...
    def transform_inputs(self, df):
        ...
        for identifier, sliced in df.groupby(id_col):
            ...
            if len(sliced) >= self._time_steps:
                ...
                sliced_copy[target_column] = self._target_scaler[identifier].\
                    transform(np.array(sliced_copy[target_column].values))
